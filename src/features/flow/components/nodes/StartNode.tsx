...
export function StartNode({ data, id, selected }: NodeProps<FlowEditorNode>) {
  ...
  return (
    <div
      className={`min-w-40 cursor-grab select-none rounded-full border-2 border-emerald-600 bg-emerald-50 px-6 py-3 text-center text-sm font-semibold text-emerald-950 shadow-sm active:cursor-grabbing ${selectionClassName} ${executionClassName}`}
    >
      <EditableNodeLabel
