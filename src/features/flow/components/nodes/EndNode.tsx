...
export function EndNode({ data, id }: NodeProps<FlowEditorNode>) {
  ...
  return (
    <div
      className={`min-w-40 rounded-full border-2 border-red-700 bg-red-50 px-6 py-3 text-center text-sm font-semibold text-red-950 shadow-sm ${executionClassName}`}
    >
      <Handle
        id="in"
        type="target"
